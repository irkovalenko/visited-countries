...
$countries[] = ["id" => "201", "name" => "Poland",         "capital" => "Warsaw",     "visited cities" => ["Warsaw", "Lublin", "Krakow", "Wroclaw", "Gdansk", "Naleczow", "Sandomierz", "Kazimierz Wielki", "Katowice", "Rzeszow", "Zakopane"]];
$countries[] = ["id" => "202", "name" => "Ukraine",        "capital" => "Kyiv",       "visited cities" => ["Kyiv", "Kharkiv", "Izium", "Luhansk", "Yalta", "Alushta", "Feodosiya", "Yevpatoria", "Truskavets"]];
$countries[] = ["id" => "203", "name" => "Russia",         "capital" => "Moscow",     "visited cities" => ["Saint Petersburg", "Sosnovyj Bor"]];
$countries[] = ["id" => "204", "name" => "Czech Republic", "capital" => "Prague",     "visited cities" => ["Prague"]];
$countries[] = ["id" => "205", "name" => "Slovakia",       "capital" => "Bratislava", "visited cities" => ["Bratislava"]];
...
$countries[] = ["id" => "401", "name" => "Austria",  "capital" => "Vienna",    "visited cities" => ["Vienna"]];
$countries[] = ["id" => "402", "name" => "Hungary",  "capital" => "Budapest",  "visited cities" => ["Budapest"]];
